...
import com.fawryEx.storyEx.Exception.ApiResponseError;
...
public class GlobalExceptionHandler {
  ...
  public @ResponseBody BaseResponse<String> handleStoreNotFoundException(
  ...
  public @ResponseBody BaseResponse<String> handleProductNotFoundException(
  ...
  public @ResponseBody BaseResponse<String> handleInsufficientStockException(
  ...
  public ResponseEntity<ApiResponseError> handleNotValidException(ProductException ex) {
